    ...
    <div style={styles.page}>
      ...
      <div style={styles.card}>
        <div style={styles.cardHeader}>
          ...
          <button style={styles.editBtn} onClick={() => setModal("info")}>Edit</button>
        </div>
      ...
      <div style={styles.card}>
        <div style={styles.cardHeader}>
          ...
          <button style={styles.editBtn} onClick={() => setModal("about")}>Edit</button>
        </div>
        {profile?.summary
      ...
      {modal === "info" && (
        <EditModal
          ...
          fields={[
            ...
            { name: "phone_number",  label: "Phone Number",  value: profile?.phone_number  || "", placeholder: "555-0100" },
